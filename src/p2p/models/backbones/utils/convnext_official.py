...
def convnext_tiny(pretrained=False, in_22k=False, **kwargs):
    model = ConvNeXt(
        depths=[3, 3, 9, 3], dims=[96, 192, 384, 768], drop_path_rate=0.1, **kwargs
    )
    if pretrained:
        url = (
...
def convnext_small(pretrained=False, in_22k=False, **kwargs):
    model = ConvNeXt(
        depths=[3, 3, 27, 3], dims=[96, 192, 384, 768], drop_path_rate=0.4, **kwargs
    )
    if pretrained:
        url = (
...
def convnext_base(pretrained=False, in_22k=False, **kwargs):
    model = ConvNeXt(
        depths=[3, 3, 27, 3], dims=[128, 256, 512, 1024], drop_path_rate=0.5, **kwargs
    )
    if pretrained:
        url = (
...
def convnext_large(pretrained=False, in_22k=False, **kwargs):
    model = ConvNeXt(
        depths=[3, 3, 27, 3], dims=[192, 384, 768, 1536], drop_path_rate=0.5, **kwargs
    )
    if pretrained:
        url = (
...
def convnext_xlarge(pretrained=False, in_22k=False, **kwargs):
    model = ConvNeXt(
        depths=[3, 3, 27, 3], dims=[256, 512, 1024, 2048], drop_path_rate=0.5, **kwargs
    )
    if pretrained:
        assert in_22k, (
            "only ImageNet-22K pre-trained ConvNeXt-XL is available; please set"
            " in_22k=True"
        )
